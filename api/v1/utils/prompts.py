...
def generate_grading_prompt(grading_model: dict) -> str:
    ...
    --- ESSAY / EXPLANATION QUESTIONS (hv) ---
    These involve written responses, definitions, analysis, or conceptual explanations.
    ...
    13. Return ONLY JSON
    14. LaTeX notation in corrections and plain text/symbols in student answers are considered equivalent if mathematically identical
    ---
